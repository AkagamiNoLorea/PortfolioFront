...
const CreatePortfolio = () => {
  ...
  const store = async (e) => {
    e.preventDefault()
    console.log(e)
    await axios.post(url, { nombre: nombre, img: img, description: descripcion, htemlValue: htemlValue, cssValue: cssValue, jsValue: jsValue, javaValue: javaValue, enlace: enlace, despliegue: despliegue })
    navigate("/")
  }
